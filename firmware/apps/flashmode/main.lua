...
-- its own - the chip waits in the bootloader, and a flash or a plain RESET is
-- what brings the firmware back up. So this is deliberately two presses behind a
